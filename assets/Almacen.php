...
<body>
            ...
            <table class="tablaUsuarios table">
                ...
                <tbody class="contenidoUsuarios">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success btn-sm editar-recurso"
                               data-toggle="modal"
                               data-target="#EditarRecurso"
                               data-id="<?php echo $recursos['IdMaterialAlmacen']; ?>"
    ...
    <div class="modal fade" id="AgregarRecurso" tabindex="-1" role="dialog" aria-labelledby="AgregarRecursoLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="EditarRecurso" tabindex="-1" role="dialog" aria-labelledby="EditarRecursoLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
