    ...
    <section>
        <div class="formularioInicio">
            <form class="formularioRegistro" id="registerForm" action="register.php" method="post">
                ...
                <input type="text" id="apPaterno" name="apPaterno" placeholder="Apellido Paterno" required maxlength="50">

                <label for="apMaterno">Apellido Materno</label>
                <input type="text" id="apMaterno" name="apMaterno" placeholder="Apellido Materno" required maxlength="50">

                <label for="telefono">Número Telefónico</label>
                <input type="number" id="telefono" name="telefono" placeholder="Número Telefónico" required maxlength="10">
                ...
                <input type="password" id="password" name="password" placeholder="Contraseña" required maxlength="50" minlength="8">

                <label for="confirmPassword">Confirmar contraseña</label>
                <input type="password" id="confirmPassword" name="confirmPassword" placeholder="Confirmar contraseña" required maxlength="50" minlength="8">
