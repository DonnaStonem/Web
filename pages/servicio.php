...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    if (isset($_GET['TipoServicio'])) {
        ...
        if ($idCliente !== null) {
            ...
            header('Location: servicios.php?view=solicitar');
            exit();
        } else {
            ...
            <div class="cards">
                <figure>
                    ...
                    <div class="serviceInfo">
                        <a href="servicios.php?TipoServicio=Mantenimiento">
                ...
                <figure>
                    ...
                    <div class="serviceInfo">
                        <a href="servicios.php?TipoServicio=Fuga">
                ...
                <figure>
                    ...
                    <div class="serviceInfo">
                        <a href="servicios.php?TipoServicio=Instalacion">
